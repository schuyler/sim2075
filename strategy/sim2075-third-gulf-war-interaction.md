...
- **Resolution missed.** The wiki held escalation (B2) as modal for 37 days; the war ended in the deal branch (B1) it had priced at 11–20%. Separately, it documented "The Third Option Pattern": seven instances of the *US* mispricing Iran's binary choices (a documented failure mode of the war's principals, not of the wiki itself).
