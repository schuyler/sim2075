...
| **1.10** | Add displacement variables to state model | ✅ | — | Completed December 2025. Added `idp_population`, `refugees_abroad`, `refugees_hosted` to state-variables-country. See [[methodology/concepts/displacement-variables-design]]. |
...
**Completed December 2025.** All 7 modular documents created. Original `state-specification` archived. Open questions from §8 distributed to relevant documents or retired.
